# prograsi Digital Innovations — Developer Playbook
...
```bash
git clone https://github.com/SLEM-Tech/prograsi-digital-innovations.git
cd prograsi-digital-innovations
...
Creates all database tables with the `prograsi_` prefix (or whatever `TABLE_PREFIX` you set). Source file: `src/lib/schema.sql`.
...
- `prograsi_categories`
- `prograsi_products`
- `prograsi_product_images`
- `prograsi_product_categories`
- `prograsi_product_attributes`
- `prograsi_orders`
- `prograsi_order_items`
- `prograsi_banners`
- `prograsi_global_settings`
- `prograsi_reviews`
...
```
GET http://localhost:3000/api/admin/bootstrap?secret=prograsi-admin-2024
```
...
curl "http://localhost:3000/api/admin/bootstrap?secret=prograsi-admin-2024"
```
...
| `http://localhost:3000/api/admin/bootstrap?secret=prograsi-admin-2024` | Create super admin account                             |
