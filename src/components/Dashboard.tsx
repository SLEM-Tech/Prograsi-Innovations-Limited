...
const Dashboard: React.FC<DashboardProps> = ({ children }) => {
  ...
  return (
    <div className="mx-auto mt-28 slg:mt-32 max-w-screen-2xl px-2 sm:px-6 lg:px-10 mb-16 sm:mb-32">
      <div className="py-10 lg:py-12 flex flex-col lg:flex-row w-full  min-h-[300px]">
        <div className="flex-shrink-0 w-full lg:w-60 px-0 sm:px-2 mr-0 lg:mr-5 transition">
          <div className="bg-background px-2 pt-3 pb-6 sm:pb-12 sm:rounded-md sticky top-32 shadow-md slg:block grid grid-cols-2 xs:grid-cols-3 gap-2 slg:gap-0">
        ...
        <div className="w-full flex-1 bg-white mt-4 lg:mt-0 p-3 sm:p-5 lg:p-8 rounded-md overflow-hidden sm:border min-h-[450px]">
          {!children && (
