  ...
  return (
    <>
      <section className="max-w-7xl mx-auto px-4 py-3 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex flex-col">
            <div className="space-y-2 border-b border-slate-100 pb-6">
              ...
              <h1 className="text-xl sm:text-2xl lg:text-4xl font-black text-slate-900 leading-tight">
                {Product.name}
              </h1>
              ...
              <div className="flex gap-4 pt-2">
                <div className="flex flex-col">
                  ...
                  <span className="text-xl sm:text-2xl lg:text-3xl font-black text-primary-100 tracking-tighter">
        ...
        <div className="mt-2 lg:mt-20 w-full overflow-x-hidden">
