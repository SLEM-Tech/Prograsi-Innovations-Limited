  ...
  return (
    <>
      ...
      <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black italic text-white leading-tight tracking-tight drop-shadow-lg">
            Quality Assesories
            <br />
            Big discount
          </h1>
          ...
          {/* Newsletter Form */}
          <div className="mt-6 flex items-center w-full max-w-[90%] sm:max-w-md bg-white rounded-full overflow-hidden shadow-lg">
            <input
              type="email"
