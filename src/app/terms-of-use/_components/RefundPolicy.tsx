...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Prograsi Innovations Limited, we strive for 100% accuracy in every
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, Prograsi Digital Innovations covers the return shipping.
            For all other approved returns, the customer bears the cost.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          At Prograsi Digital Innovations, we act as your dedicated procurement
