  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        /* ========== prograsi Brand Foundation ========== */
        // The deep navy blue seen in the "Maintenance" banner
        brand: {
          navy: "#083272",
          blue: "#0D47A1", // Standard blue for buttons/icons
          light: "#E3F2FD", // Light blue for hover states/bg
        },
        ...
        primary: {
          100: "#0D47A1", // Main Button Blue
          200: "#0A3A8A",
          300: "#083272", // Deep Navy
          400: "#062654",
          DEFAULT: "#0D47A1",
        },
        ...
        accent: "#0D47A1",
        price: "#083272", // Deep navy for price text
        whatsapp: "#25D366",
      },
