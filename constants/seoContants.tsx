...
export const SITE_NAME = "Prograsi Innovations Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://prograsi.com"; // Update with actual URL
export const TWITTER_HANDLE = "@prograsi";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Prograsi Innovations Limited Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "Prograsi Innovations Limited",
  ...
  home: {
    ...
    description:
      "Innovate and grow with Prograsi Innovations Limited. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Prograsi Innovations Limited client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Prograsi Innovations Limited dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Prograsi Innovations Limited and access premium tech resources.",
    keywords: [
      "Get started with Prograsi Innovations Limited",
      "Project onboarding",
      "Digital partnership",
    ],
  },
